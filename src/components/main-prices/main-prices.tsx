          ...
          <div className="table-price__filters">
            <form className="table-price__search-form">
              <label className="table-price__name-label">
                <input className="input table-price__name-input" type="text" placeholder="Название товара" />
            ...
            <div className="calendar table-price__calendar">
              ...
              <span className="calendar__date">14.07.2022</span>
            </div>
            ...
            <button className="button button--rounded table-price__button">Добавить товар</button>
          </div>
